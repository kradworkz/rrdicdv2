...
Vue.component('institutions', require('./components/Admin/Institution/Index.vue').default);
Vue.component('institution-create', require('./components/Admin/Institution/Create.vue').default);
